...
4. Specify its default tier (`live`/`archive`/`canon`) in SKILL.md frontmatter. (Non-archetype skills — primers, meta-skills, adapters, compliance — use `type:` to declare their role instead; they have no tier since they don't produce records.)
